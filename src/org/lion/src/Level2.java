...
public class Level2 extends JPanel {
    ...
    Food banana = new Food(2000, 100, "./Gimg/apple.png");
    Font font = new Font("SanSerif", Font.BOLD, 30);
    GameWindow Gwindow;
    mainWindow mWin;
    Sound sound = new Sound("./mp3/jungle.wav");

    public Level2(GameWindow window, int seconds, mainWindow main) {
        ...
        ImageIcon icon = new ImageIcon("./Gimg/level2.jpg");
        bakImag = icon.getImage();
        ant = new Ant();
        ant.setEndValue(2050);
        ant.setBulletSize(8);
        en1 = new Enemy(300, 300, "./Gimg/Enemy/frog.png");
        en2 = new Enemy(en1.getX() + 250, 300, "./Gimg/Enemy/frog.png");
        en3 = new Enemy(en2.getX() + 250, 300, "./Gimg/Enemy/frog.png");
        en4 = new Enemy(en3.getX() + 250, 300, "./Gimg/Enemy/frog.png");
        en5 = new Enemy(en4.getX() + 250, 300, "./Gimg/Enemy/frog.png");
        en6 = new Enemy(en5.getX() + 250, 300, "./Gimg/Enemy/frog.png");
        en7 = new Enemy(en6.getX() + 250, 300, "./Gimg/Enemy/frog.png");
...
//            }
            ...
            if (ant.getX() > 1400 && ant.getX() < 1600) {
                setFrut(true);
            } else {
                setFrut(false);
            }
