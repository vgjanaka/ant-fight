...
public class Level4 extends JPanel {
    ...
    Image bakImag;
    Ant ant;
    Enemy en1, en2, en3, en4, en5, en6, en7, en8, en9, en10, en11;
    ...
    Food banana = new Food(3000, 100, "./Gimg/Mango.png");
    Font font = new Font("SanSerif", Font.BOLD, 30);
    GameWindow Gwindow;
    mainWindow mWin;
    Sound sound = new Sound("./mp3/jungle.wav");

    public Level4(GameWindow window, int seconds, mainWindow main) {
        ...
        ImageIcon icon = new ImageIcon("./Gimg/level4.jpg");
        bakImag = icon.getImage();
        ant = new Ant();
        ant.setEndValue(3150);
        ant.setBulletSize(12);
        ant.setWidth(200);
        ant.setHieht(235);
        ant.setAntImg(new ImageIcon("./Gimg/ant/ant5.png").getImage());
        banana.setWidth(200);
        banana.setHieht(160);
        en1 = new Enemy(300, 300, "./Gimg/Enemy/animal.png");
        en2 = new Enemy(en1.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en3 = new Enemy(en2.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en4 = new Enemy(en3.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en5 = new Enemy(en4.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en6 = new Enemy(en5.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en7 = new Enemy(en6.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en8 = new Enemy(en7.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en9 = new Enemy(en8.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en10 = new Enemy(en9.getX() + 250, 300, "./Gimg/Enemy/animal.png");
        en11 = new Enemy(en10.getX() + 250, 300, "./Gimg/Enemy/animal.png");
...
//            }
            ...
            g2d.drawImage(banana.getFoodImage(), banana.getX(), banana.getY(), null);
