...
public class Level3 extends JPanel {
    ...
    Image bakImag;
    Ant ant;
    Enemy en1, en2, en3, en4, en5, en6, en7, en8, en9;
    ...
    Food banana = new Food(2500, 200, "./Gimg/Strawberry.png");
    ...
    public Level3(GameWindow window, int seconds, mainWindow main) {
        ...
        ImageIcon icon = new ImageIcon("./Gimg/level3.jpg");
        bakImag = icon.getImage();
        ant = new Ant();
        ant.setEndValue(2520);
        ant.setBulletSize(10);
        en1 = new Enemy(300, 300, "./Gimg/Enemy/snake.png");
        en2 = new Enemy(en1.getX() + 250, 300, "./Gimg/Enemy/snake.png");
        en3 = new Enemy(en2.getX() + 250, 300, "./Gimg/Enemy/snake.png");
        en4 = new Enemy(en3.getX() + 250, 300, "./Gimg/Enemy/snake.png");
        en5 = new Enemy(en4.getX() + 250, 300, "./Gimg/Enemy/snake.png");
        en6 = new Enemy(en5.getX() + 250, 300, "./Gimg/Enemy/snake.png");
        en7 = new Enemy(en6.getX() + 250, 300, "./Gimg/Enemy/snake.png");
        en8 = new Enemy(en7.getX() + 250, 300, "./Gimg/Enemy/snake.png");
        en9 = new Enemy(en8.getX() + 250, 300, "./Gimg/Enemy/snake.png");
